                       ...
                       <div class="row">
                           <div class="col-lg-12">
                               <div class="informeson">
                                   <h1>{{$property -> name}}<span>₦ {{ number_format($property -> total_price)}}</span></h1>
                                   <div>
                                       <div class="float-left">
                                           <ul class="clearfix">
                                               <li><i class="flaticon-bed"></i>{{$property -> rooms}} rooms </li>
                                               <li><i class="flaticon-bath"></i>{{$property -> bedrooms}} bedrooms </li>
                                               <li><i class="flaticon-square-layouting-with-black-square-in-east-area"></i>{{$property ->area}} meter</li>
        ...
        <div class="row">
            <div class="col-lg-8 col-md-12 slider">
                    ...
                    <div class="row">
                        <div class="col-md-4 col-sm-6">
                            <ul>
                                ...
                                <li>
                                    <strong>Price:</strong>₦ 35,000/ Month
                                </li>
                                <li>
                ...
                <div class="property-video mb-60">
                    ...
                    <iframe src="https://www.youtube.com/embed/mJVuZiK9a6I"></iframe>
                </div>
                    ...
                    <div class="contact-3 financing-calculator widget-3">
                        ...
                        <form action="#" method="GET" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="₦ 36.40">
                            </div>
                            <div class="form-group">
