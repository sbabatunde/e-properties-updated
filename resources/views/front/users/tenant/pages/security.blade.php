...
@section('content')
    ...
    <div class="page-hero bg-image"
        ...
        <div class="hero-section d-flex justify-content-center align-items-center">
            <div class="centered-text text-center text-white">
                <h1 class="text-white">Property Security Services</h1>
                <p class="text-white">Comprehensive solutions to ensure the safety of your property.</p>
            </div>
        </div>
    </div>
    ...
    <section class="container mt-5">
        ...
        <section class="overview-section mb-5">
            <h2>Why Secure Your Property?</h2>
            <p>
                Protecting your property is our priority. Our platform connects you with trusted security professionals,
                offering solutions tailored to your needs, whether it's installing surveillance systems or hiring on-site
                security personnel.
            </p>
        </section>
        ...
        <section class="services-list mb-5">
            <h2>Our Security Solutions Include:</h2>
            <div class="row">
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="service-card">
                        <i class="fa fa-video-camera"></i>
                        <h5>Surveillance Systems</h5>
                        <p>Get modern CCTV systems installed to monitor your property 24/7.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="service-card">
                        <i class="fa fa-shield"></i>
                        <h5>On-Site Security</h5>
                        <p>Hire trained personnel to safeguard your property.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="service-card">
                        ...
                        <p>Secure your premises with state-of-the-art access control solutions.</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="cta mt-5 text-center"
            ...
            <p style="font-size: 1.2rem; font-weight: bold; color: #fff;">Looking for reliable security services?</p>
