<form id="bidPlacement" class="form-group" action="{{ route('user.auction.place-bid.amount') }}" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="modal fade"  id="placeBid" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="placeBidLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" style="margin-top:20vh">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="form-group name2 col-md-12">
                        <label for="exampleInputEmail1## Heading ##" class="formText" style="font-size:16px"><strong>Enter your Bid: </strong></label>
                        ...
                        pattern="^\₦ \d{1,3}(,\d{3})*(\.\d+)?₦"  data-type="currency" placeholder="₦" style="border: 1px solid #2626ac">
                    </div>
                    <label class="form-group name2 col-md-12 mt-0">
                        ...
                        <button type="submit" class="btn btn-place-bid mt-1">
                            Place a Bid
                        </button>
                    </label>
                </div>
