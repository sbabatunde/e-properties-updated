            ...
            <div class="col-md-12">
                <div class="col-md-12 mt-3 ml-5" style="">
                    <div class="btn service-btn-group btn-container d-flex justify-content-center">
                        <button onclick="maintenance()" class="active-btn-group req-target">
                            <strong>
                                Maintenance
                            </strong>
                        </button>
                        <button onclick="property()" class="active-btn-group">
                            <strong>
                                Property
                            </strong>
                        </button>
                        <button onclick="b_development()" class="active-btn-group">
                            <strong>
                                Building Development
                            </strong>
                        </button>
                        <button onclick="legal()" class="active-btn-group">
                            <strong>
                                Legal
                            </strong>
                        </button>
                ...
                <div class="row ml-3 service-content">
                    <div class="col-md-2 mr-4 mt-2">
                        <div class="service-card">
                            <img src="../assets/images/services/service5.png" alt="Avatar" style="width:100%;"
                    ...
                    <div class="col-md-2 mr-4 mt-2">
                        <div class="service-card">
                            <img src="../assets/images/services/service6.png" alt="Avatar" style="width:100%;"
                                height="150" width="100">
                            <div class="container mt-3  follow-text">
                    ...
                    <div class="col-md-2 mr-4 mt-2">
                        <div class="service-card">
                            <img src="../assets/images/services/service9.png" alt="Avatar" style="width:100%;"
                                height="150" width="100">
                            <div class="container mt-3  follow-text">
                    ...
                    <div class="col-md-2 mr-4 mt-2">
                        <div class="service-card">
                            <img src="../assets/images/services/service8.png" alt="Avatar" style="width:100%;"
                                height="150" width="100">
                            <div class="container mt-3  follow-text">
