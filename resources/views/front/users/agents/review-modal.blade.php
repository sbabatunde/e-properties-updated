...
<div id="reviewModal" class="modal">
    <div class="modal-content">
        ...
        <h2>Post a Review on <span style="color: #394293">
                {{ $propertyProfessional->firstname }} {{ $propertyProfessional->lastname }}
            </span> </h2>
        <div class="modal-form">
            <form class="d-inline" method="POST" enctype="multipart/form-data"
                action="{{ route('professional.review', $propertyProfessional->id) }}">
                @csrf
