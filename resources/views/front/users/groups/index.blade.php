...
<!-- Sub banner start -->
<div class="sub-banner" style="background: url({{ asset('assets/images/services/banner.png') }});
...
<div class="all-group">
    <div class="left-grp">
        <div class="btn all-group-btn btn-container d-flex justify-content-center " >
            <button  class="all-group-btn active-btn-group toggleButton" data-target="showPost">
                <strong>
                    Post
                </strong>
            </button>
