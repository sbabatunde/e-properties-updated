<div class="hero-category">
    <div class="hero-meet-expert">
        ...
        <a href="{{ route('all.residential') }}" style="text-decoration: none"><h5 style="color: red">See more</h5></a>
    </div>
        ...
        @foreach($data['properties'] as $key=>$item)
            <div class="pic">
                ...
                <span class="listing-text">
                    ...
                    <p>
                        <span style="font-size:15px">{{ $item['localty'] }}</span><br>
                        <span style="font-size:20px;font-weight:bold">{{ $item['initial_denomiation'] }} {{ number_format($item['initial_pay']) }}</span>
                    </p>
