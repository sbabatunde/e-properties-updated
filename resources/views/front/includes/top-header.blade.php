        ...
        <div class="row">
            <div class="col-md-12">
                <ul class="row nav-bar-row">
                    ...
                    <div class="nav-link">
                        <li> 
                            <a href="{{ route('landlord.index') }}" class="{{ request()->is('landlord.index') ? 'text-red': 'text-green'}}">
                    ...
                    @else
                        <div class="nav-link login">
                            <div class="row">
                                ...
                                <li class="ml-3"> 
                                    <a href="{{route('login')}}" type="button" class="btn login-button" style="color:#394293;">
                                        <strong>
                                        Login
                                        </strong>  
                                    </a>
