<div class="form-group col-md-12">
    ...
    <textarea required type="text"  placeholder="Describe your property" style="border: 1px solid rgb(224, 223, 223); 
...
<div class="form-group col-md-12 bg-white flex" style="height:20vh">
    <input required id="avatar" type="file" name="amenities[]" multiple accept="image/png, image/jpeg" style="float-left:50% " />
    @error("amenities")
    <span class="text-danger">{{$message}}</span>
    @enderror
</div>
