    ...
    <h5> 
        <strong style="color:black">
             ...
             <label class="container">
                <input type="checkbox" id="myDeal" value="Yes" style="border: 1px solid rgb(224, 223, 223);border-radius:7px"
                class="rounded-md shadow-sm border-gray-300 mt-1" onclick="propertyDeal()"
                name="deal">
