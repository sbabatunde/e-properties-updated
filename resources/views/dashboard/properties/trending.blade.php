                ...
                <div class="col-lg-12 col-md-12">
                    <div class="">
                        <div class="">
                                ...
                                <div class="col-md-11">
                                    <div class="form-body">
                                        <table>
                                            ...
                                            <tbody>
                                                <tr>
                                                    @isset($trendingProperties)
                                                        @foreach ($trendingProperties as $index => $property)
                                                    <tr>

                                                        <td>
                                                            {{ ($trendingProperties->currentPage() - 1) * $trendingProperties->perPage() + $index + 1 }}
                                                        </td>
                                                        ...
                                                        <td class="table-btn">
                                                            <form id="removeTrending{{ $property->id }}" {{-- style="display: none" --}}
                            ...
                            <div>
                                @if (count($trendingProperties) > 0)
                                    <div class="pagination mt-5 ml-2 d-flex justify-content-center">
                                        {{ $trendingProperties->links('vendor.pagination.custom') }}
                                    </div>
                                @endif
                            </div>
