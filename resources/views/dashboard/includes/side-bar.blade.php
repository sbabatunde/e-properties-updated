...
<!-- sidebar menu -->
<div id="sidebar-menu" class="main_menu_side hidden-print main_menu" style="color: #394293">
    <div class="menu_section">
        ...
        <ul class="nav side-menu">
            <li>
                <a>
                    <i class="fa fa-home">
                    </i>{{ __('admin/sidebar.categories') }} <span class="fa fa-chevron-down"></span>
                </a>
                <ul class="nav child_menu">
                    <li><a href="{{ route('admin.categories') }}">{{ __('admin/sidebar.all categories') }}</a></li>
                    <li><a href="{{ route('admin.categories.create') }}">{{ __('admin/sidebar.add new category') }}</a>
                    </li>
                </ul>
            </li>
        </ul>
        ...
        <ul class="nav side-menu">
            <li>
                <a>
                    <i class="fa fa-home"></i>{{ __('admin/sidebar.cities') }} <span class="fa fa-chevron-down"></span>
                </a>
                <ul class="nav child_menu">
        ...
        <ul class="nav side-menu">
            <li>
                <a><i class="fa fa-user"></i>Profile<span class="fa fa-chevron-down"></span></a>
                <ul class="nav child_menu">
                    <li><a href="">My Profile</a></li>
                    <li><a href="{{ route('admin.edit.profile') }}">Edit Profile</a></li>
                </ul>
            </li>
        </ul>
        ...
        <ul class="nav side-menu">
            <li>
                <a><i class="fa fa-user"></i>My listings<span class="fa fa-chevron-down"></span></a>
                <ul class="nav child_menu">
