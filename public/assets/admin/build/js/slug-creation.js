/*
    ...
    InputPresetSlug({
        selectFields: '.test', - selector fields for create slug
        writingField: '#name', - selector field output slug 
    })

    removeStopWords - use removeList to filter stop words of source string (optional), default true.

 */
    function InputPresetSlug(options) {
        ...
        if (typeof(options.removeStopWords)==='undefined') options.removeStopWords = true;
    
        function removeStopWords(str) {
            
            if (options.removeStopWords == true) {
                let regex = new RegExp('\\b(' + removeList.join('|') + ')\\b', 'gi')
        ...
        $(options.writingField).val(Slug(options.selectFields))
    
        $(options.selectFields).keyup(function() {
